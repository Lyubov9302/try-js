...
// - збереження
// - чому треба викор метод JSON.stringify();
...
// - читання
// - чому треба викор метод JSON.parse;
...
// - LocaStorage не може зберігати функції
...
// ------------------
// ловити подію, відстежувати введення або виведення кожного символа
...
// - видалямо повідомлення зі сховища
// - очищуємо
...
totalPrice.textContent = totalCost ?`Total cost ${totalCost} гра` : "Your basket is empty";
