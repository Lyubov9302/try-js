...
// 11 - стрілочні функції


// a) напиши стрілочну функцію, яка виводить у консоль "Привіт, світ!"
...
// b) створи стрілочну функцію greetUser,
//  яка приймає імя та виводить у консоль "Привіт, [імя]"

// const greetUser = (name) => {
//     console.log(`Привіт, ${імя}`);
// }
